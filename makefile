...
bin/turing-test: build/test/turing-test.o build/test/check_error-test.o build/test/do_s-test.o build/test/move-test.o build/test/print_string-test.o build/test/input_main_row-test.o
	$(COMPILER) $(CFLAGS) $^ -o $@
