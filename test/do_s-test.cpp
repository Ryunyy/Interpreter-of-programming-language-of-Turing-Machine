...
TEST_CASE("DO_s-test", "[DO_S-test]"){
	...
	rules[0].state = "q1"; rules[0].exp_symbol = "5"; rules[0].new_symb = "_"; rules[0].move = "r"; rules[0].next_state = "halt";
	main_row = "________5________";
	REQUIRE(do_s(rules, main_row, 0, 8) == "_________________");
	cout << "test [do_s 2] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "0"; rules[0].new_symb = "!"; rules[0].move = "r"; rules[0].next_state = "halt";
	main_row = "!!!!!!!!!!!!!!!!!!!!!0";
	REQUIRE(do_s(rules, main_row, 0, 21) == "!!!!!!!!!!!!!!!!!!!!!!");
	cout << "test [do_s 3] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "F"; rules[0].new_symb = "f"; rules[0].move = "r"; rules[0].next_state = "halt";
	main_row = "qazxswedcvFrtgbnhyujm";
	REQUIRE(do_s(rules, main_row, 0, 10) == "qazxswedcvfrtgbnhyujm");
	cout << "test [do_s 4] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "."; rules[0].new_symb = ","; rules[0].move = "r"; rules[0].next_state = "halt";
	main_row = "1.12312312312";
	REQUIRE(do_s(rules, main_row, 0, 1) == "1,12312312312");
	cout << "test [do_s 5] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "_"; rules[0].new_symb = "r"; rules[0].move = "r"; rules[0].next_state = "halt";
	main_row = "Hello_use_";
	REQUIRE(do_s(rules, main_row, 0, 9) == "Hello_user");
	cout << "test [do_s 6] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "s"; rules[0].new_symb = "A"; rules[0].move = "r"; rules[0].next_state = "halt";
	...
	rules[0].state = "q1"; rules[0].exp_symbol = "9"; rules[0].new_symb = "8"; rules[0].move = "r"; rules[0].next_state = "halt";
	...
	rules[0].state = "q1"; rules[0].exp_symbol = "_"; rules[0].new_symb = "-"; rules[0].move = "r"; rules[0].next_state = "halt";
	main_row = "328_823";
