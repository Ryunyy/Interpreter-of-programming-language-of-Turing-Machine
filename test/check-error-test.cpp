...
TEST_CASE("Check error test:", "[Checkerrortest]")
{
	...
	rules[0].state = "q1"; rules[0].exp_symbol = "W"; rules[0].new_symb = "!"; rules[0].move = "r"; rules[0].next_state = "qwe";
	REQUIRE(check_error(rules) == 1);
    cout << "test [check_error 2] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "_"; rules[0].new_symb = "#"; rules[0].move = "n"; rules[0].next_state = "next";
	REQUIRE(check_error(rules) == 1);
    cout << "test [check_error 3] successful" << endl;

	rules.resize(3);
	rules[0].state = "q1"; rules[0].exp_symbol = "q"; rules[0].new_symb = "w"; rules[0].move = "r"; rules[0].next_state = "123456789";
	...
	rules.resize(10);
	rules[0].state = "q1"; rules[0].exp_symbol = "1"; rules[0].new_symb = "1"; rules[0].move = "r"; rules[0].next_state = "next1";
	...
	rules[0].state = "q1"; rules[0].exp_symbol = "Ww"; rules[0].new_symb = "!"; rules[0].move = "r"; rules[0].next_state = "qwe";
	REQUIRE(check_error(rules) == 0);
    cout << "test [check_error 2] successful" << endl;

	rules[0].state = "q1"; rules[0].exp_symbol = "_"; rules[0].new_symb = "#"; rules[0].move = "left"; rules[0].next_state = "next";
	REQUIRE(check_error(rules) == 0);
    cout << "test [check_error 3] successful" << endl;

	rules.resize(3);
	rules[0].state = "q1"; rules[0].exp_symbol = "q"; rules[0].new_symb = "w"; rules[0].move = "r"; rules[0].next_state = "1234567891011";
